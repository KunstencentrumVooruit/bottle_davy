...
ajax_ticker.prototype.initialize=function(){
	if (this.ajaxobj.readyState == 4){ //if request of file completed
		if (this.ajaxobj.status==200 || window.location.href.indexOf("http")==-1){ //if request was successful
			...
			if (this.contentdiv.getElementsByTagName("song").length==0){ //if no messages were found
		...
		//}
		this.messages[0]="Now Playing"		
		this.messages[1]=this.contentdiv.getElementsByTagName("artist")[0].innerHTML + " - " + this.contentdiv.getElementsByTagName("title")[0].innerHTML
