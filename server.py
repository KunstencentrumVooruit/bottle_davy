...
@route('/menucafe')
def menucafe():
	menu = libs.menucafe.getMenu()
	return template('menucafe', data=menu)
...
def _returnFestFootageNext():
	...
	caption = pic[0:pos]
	pos2 = pic.find('__')
	#copywright = pic[pos+2:pos2]
	#caption2="#"+caption.replace('_',' ')
	#return "{\"caption\" : \"" + caption2 + "\", \"url\" : \"" + pic + "\", \"copywright\" : \"" + copywright2 + "\"}"
	caption = pic[0:pos]
	caption2="#"+caption.replace('_',' ')
